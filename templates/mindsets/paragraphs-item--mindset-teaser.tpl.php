<div class="dcf-d-flex dcf-jc-center <?php print $classes; ?>"<?php print $attributes; ?>>
  <div class="content dcf-d-flex dcf-flex-col dcf-flex-nowrap dcf-w-max-md dcf-w-100% dcf-bg-white dcf-rounded unl-box-shadow dcf-card-as-link"<?php print $content_attributes; ?> style="cursor: pointer;">
